    ...
    <head>
        ...
        <script>
            ...
            function col(frm) {
                c = frm
                    .selectBox
                    .options[frm.selectBox.selectedIndex]
                    .text;
                if (c == 'Pink') {
                    document
                        .getElementById("main")
            ...
            function cart() {
                ...
                location.href = 'cart_add.php?cid=<?php echo $customer; ?>&fid=<?php echo $id;?>&quantity=' 1;
            }
        </script>
        <style>
            .jumbotron {
        ...
        <div>
            ...
            <div>
                ...
                <img
                    id="main"
                    src="pral.png"
                    style="float: left; margin-left: 300px; margin-right: 100px;">
                <div class="order">
                    <br><br>
                    <h3
                        style="text-align: left; margin-left: 50px; font-size: 30px; color: rgb(73, 73, 73);">Create Bouquet
                    </h3>
                    <div style="text-align: left;">
                        <br>
                        <form name="form" method="post" action="buy.php">
                            ...
                            <select name="WrapColor" class="btn1" onchange="col(this.form);">
                            ...
                            <select name="FlowerType" class="btn1" onchange="flo(this.form);">
                            ...
                            <select name="Size" class="btn1" onchange="si(this.form);">
                            ...
                            <br><br>
                            <input class="btn1" type="submit" value="Buy"/>
                            <input
                                class="btn1"
                                type='button'
                                value='Cart'
                                onclick='return info_chk2(this.form);'>
                ...
                <div class="clear">
                    <br>
                    <hr>
                    <p style="font-weight: bold; font-size: 20px; color: red;">In the case of real
                        flowers, exchange/refund because of a change of heart is not allowed.</p>
                    <hr><br>
                    ...
                    <p style="font-size: 20px;">Third, select the size.<br>
                        ...
                        S size is 4-6 flowers, m size is 7-11 flowers, and l size is about 12-20
                        flowers.</p>
                    <hr><br>
                    <p style="font-size: 30px; font-weight: 500;">4. Create</p>
                    <img src="q4.png" alt="">
                    <p style="font-size: 20px;">Select all items and press the Create button to see the completed bouquet.<br>
