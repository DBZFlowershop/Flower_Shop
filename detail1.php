...
<div class="row" style="padding-top:30px; padding-bottom:30px;">
  ...
  <div class="col-sm-10" name="centerline">
    ...
    <div class="col-sm-6" name="imageline">
      <img id="itemimg" src="summer10.jpeg" style="float: left; ">
    </div>
    <div class="col-sm-6">
      <h3 id="itemname" style="text-align: left;">Product Name</h3>
      <div style="text-align: left;">
        <br>
        <hr><br>
        <p style="font-weight:bold;">Shipping Informations</p>
        <input type="radio" name="chk_info" value="HTML">Pick-Up
        <input type="radio" name="chk_info" value="CSS">Quick Service
        <br><br><br>
        <p style="font-weight:bold;">Quantitiy</p>
        <form>
          <input type=button value="-" onClick="javascript:this.form.amount.value--;">
          <input type=text id="itemcount" name=amount value=1>
          <input type=button value="+" onClick="javascript:this.form.amount.value++;">
        </form>
        <br><br>
        <p>Total Price : </p>
        <p id="itemprice"> example won</p>
        <br><br>
