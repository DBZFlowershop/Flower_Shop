...
/* db 생성 */
$create_db = "CREATE DATABASE flower_shop";
...
$create_flower_table = "CREATE TABLE Flower(
...
/* 상황별 꽃들 삽입 */
$insert_situation_flowers = "INSERT INTO Flower VALUES
...
/* 상황별 꽃 설명 테이블 weak entity 생성*/
$create_explanation = "CREATE TABLE FlowerExplanation( 
    FlowerID INT UNSIGNED REFERENCES Flowers(FlowerID) ON DELETE CASCADE, /* Flowers에 종속됨 */
    Explanation VARCHAR(80) NOT NULL,
    PRIMARY KEY(FlowerID)
)";

/* 상황별 꽃에 설명 삽입 */
$insert_explanation = "INSERT INTO FlowerExplanation(
    ...
    (005, 'Mother's Day'),
    (006, 'Couple's anniversary'),
    (007, 'Christmas'),
    (008, 'Wedding')
)";

/* 계절별 꽃 삽입 */
$insert_seasonal_flowers = "INSERT INTO Flower VALUES
    ...
    (029, 'Cosmos', 30, 'Fall', 'fall12.jpg'),
    (030, 'Cotton flower', 25, 'Winter', 'winter1.jpg'),
    (031, 'Stoke', 30, 'Winter', 'winter2.jpg'),
    (032, 'Siklamen', 30, 'Winter', 'winter3.jpg')
";

/* flower 테이블에 커스텀 꽃 삽입 */
$insert_custom_flowers = "INSERT INTO Flower(FlowerID, FlowerName, FlowerPrice, Categroy, FlowerImg) VALUES 
...
/* 커스텀 꽃 테이블 생성 */
$create_custom_table = "CREATE TABLE Custom(
    CustomID INT,
    FlowerID INT, 
...
/* Custom 테이블에 커스텀 꽃 삽입 */
$insert_custom_custom = "INSERT INTO Custom(CustomID, FlowerID, WrapColor, FlowerType, Size) VALUES 
