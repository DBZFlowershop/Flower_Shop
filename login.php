...
<body>
  ...
  <div class="col-lg-8">
    ...
    <!-- <ul>
      ...
      <li><a href="#" id="navbardrop" data-toggle="dropdown">Recommend</a>
    ...
    <button onclick="jo()" style="margin-top: 200px;">Join</button>
    <div class="jumbotron" style="padding-top: 20px;">
      <h3 style="text-align: center;">Login</h3><br>
      <form action="main.html" method="POST" onsubmit="login();" style="text-align:center;">
        <table class="j_table">
          <tr class="j_tr">
            <td class="j_td">ID</td>
